...
+ (BOOL)getIsDebug SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC5AceTM5AceTM") SWIFT_AVAILABILITY(ios,introduced=8)
...
- (void)addSendQueue:(NSString * _Nonnull)queryString;
+ (void)pvWithResponder:(UIResponder * _Nonnull)responder;
+ (void)pvWithPage:(NSString * _Nonnull)page;
+ (void)pushWithData:(NSDictionary * _Nonnull)data;
...
+ (void)uiWebViewDidStartLoadWithWebView:(UIWebView * _Nonnull)webView;
+ (void)webViewDidFinishLoadWithWebView:(UIWebView * _Nonnull)webView;
+ (void)uiWebViewDidFinishLoadWithWebView:(UIWebView * _Nonnull)webView;
+ (void)loadView:(id <WKScriptMessageHandler> _Nonnull)scriptMessageHandler wkUserContentController:(WKUserContentController * _Nonnull)wkUserContentController;
+ (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceive:(WKScriptMessage * _Nonnull)message :(NSString * _Nonnull)name;
